						...
						<div class="card-footer">
							<nav aria-label="Navigation">
								<ul class="pagination justify-content-center m-0">
									...
									<li class="page-item">
										<a class="page-link" href="javascript:list_go(<%= pageMaker.getStartPage() - 1%>);">
								...
								%>
									...
									<li class="page-item">
										<a class="page-link" href="javascript:list_go(<%=pageMaker.getEndPage()%> + 1);">
											<i class="fas fa-angle-right"></i>
										</a>						
									</li>
									<li class="page-item">
										<a class="page-link" href="javascript:list_go(<%=pageMaker.getRealEndPage()%>);">
